								...
								<div class="panel panel-white no-radius text-center">
									<div class="panel-body">
										...
										<p class="links cl-effect-1">
											<a href="update-doctor.php">
												<?php $result = mysqli_query($con,"SELECT * FROM doctors where id='".$_SESSION['id']."'");
												$row = mysqli_fetch_array($result);
												{
													?>
													Current Doctor : <?php echo htmlentities($row['doctorName']);  } ?>		
												</a>
											</p>
										</div>
									</div>
											...
											<div class="panel-body">
												...
												<p class="links cl-effect-1">
														<a href="manage-appointment.php">
															<?php $sql= mysqli_query($con,"SELECT * FROM appointment where doctorId='".$_SESSION['id']."'");
									...
									<div class="col-sm-4">
										<div class="panel panel-white no-radius text-center">
											<div class="panel-body">
												<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="far fa-head-side-medical fa-stack-1x fa-inverse"></i> </span>
												...
												<p class="links cl-effect-1">
														<a href="manage-patient.php">
															...
															{
																?>
																My Patients :<?php echo htmlentities($rows2); } ?>	
															</a>
														</a>
													</p>
												</div>

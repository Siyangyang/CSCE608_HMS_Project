...
check_login();
$aid=intval($_GET['id']);// get doctor id
			...
			<div class="main-content" >
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Doctor | Edit Appoinment Details</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Doctor</span>
													...
													while($data=mysqli_fetch_array($sql))
													{
														...
														<form role="form" name="appointmentedit" method="post" onSubmit="return valid();">
																...
																<div class="form-group">
																	...
																	$sql=mysqli_query($con,"select doctors.speciality from doctors where id=".$data['doctorId']." ");
																	$data1 = mysqli_fetch_array($sql);
																	echo htmlentities($data1['speciality']);?></textarea>
																</div>
